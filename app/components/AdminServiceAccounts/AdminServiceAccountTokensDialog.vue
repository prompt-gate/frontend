    ...
    <v-card rounded="xl" class="admin-service-account-tokens-dialog">
      ...
      >
        <v-card
          rounded="lg"
          variant="flat"
          class="admin-service-account-tokens-dialog__create-card"
        >
          <v-card-item
            class="admin-service-account-tokens-dialog__section-header"
          >
            <template #prepend>
            ...
            <v-card-title
              class="admin-service-account-tokens-dialog__section-title"
            >
              Create virtual key
            </v-card-title>
            <v-card-subtitle
            ...
            >
              Generate a new virtual key for this service account.
            </v-card-subtitle>
          </v-card-item>
...
.admin-service-account-tokens-dialog__create-card {
...
.admin-service-account-tokens-dialog__section-header {
